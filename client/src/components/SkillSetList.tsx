...
export function SkillSetList(): JSX.Element {
    ...
    return <motion.ul ref={skillSetRef}
                      className={'skill-set justify-center align-middle flex-wrap border-violet-800 bg-gray-100 bg-opacity-100 text-[var(--dark-grey-text)] list-item overflow-hidden'}
                      variants={boxVariant}
                      animate={'visible'}
                      initial="hidden"
    >
